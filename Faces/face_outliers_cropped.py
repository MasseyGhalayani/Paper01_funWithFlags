    ...
    for trial in range(5):
        ...
        for face_num in np.arange(1,39):
            ...
            for n_out  in n_outs:
                ...
                np.save(f'./{dir_name}/labels/lbl_{n_out}_t{trial}.npy', labels)
                ...
                np.save(f'./{dir_name}/pca/preds_{face_id}_{n_out}_t{trial}.npy', pca_preds)
                ...
                for pca_type in ['rpca', 'wpca', 'dpcp']:
                    ...
                    if pca_type == 'dpcp':
                        Wfpca = fdr.flag_robust_pca(Xunit.T, [1,3], pca_type, verbose = False, 
                        ...
                        Wfpca = fdr.flag_robust_pca(Xcenter.T, [1,3], pca_type, verbose = False, 
                                                    return_all = False, max_iters = 200, init = 'rand')
                    ...
                    np.save(f'./{dir_name}/{pca_type}/preds_{face_id}_{n_out}_t{trial}.npy', fpca_preds)
