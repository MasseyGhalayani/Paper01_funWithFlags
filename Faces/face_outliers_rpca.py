...
if __name__ == '__main__':
    ...
    for face_num in np.arange(1,40):
        ...
        for n_out  in n_outs:
            ...
            for fl_type in fl_types:
                ...
                Wfpca = fdr.flag_robust_pca(Xcenter.T, fl_type, 'rpca', verbose = False, 
                ...
                np.save(f'./results/rpca/preds_{face_num}_{fl_type}_{n_out}.npy', fpca_preds)
        ...
        np.save(f'results/rpca/{face_num}_times.npy', times)
